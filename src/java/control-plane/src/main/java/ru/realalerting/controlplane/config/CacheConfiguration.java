...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, ru.realalerting.controlplane.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, ru.realalerting.controlplane.repository.UserRepository.USERS_BY_EMAIL_CACHE);
