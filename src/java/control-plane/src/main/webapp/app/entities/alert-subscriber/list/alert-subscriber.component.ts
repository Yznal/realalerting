...
import { EntityArrayResponseType, AlertSubscriberService } from '../service/alert-subscriber.service';
...
export class AlertSubscriberComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.subscription = combineLatest([this.activatedRoute.queryParamMap, this.activatedRoute.data])
      .pipe(
        ...
        tap(() => {
          if (!this.alertSubscribers || this.alertSubscribers.length === 0) {
            this.load();
          }
        }),
      )
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.alertSubscribers = this.refineData(dataFromBody);
  }

  protected refineData(data: IAlertSubscriber[]): IAlertSubscriber[] {
