...
import { sampleWithRequiredData } from '../metric.test-samples';
...
describe('Metric Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, MetricComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to metricService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMetricIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMetricIdentifier).toHaveBeenCalledWith(entity);
